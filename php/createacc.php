            ...
            echo "<div class='exist-msg'><h1>".$sitename."</h1>
                ...
                if(isset($_POST['signup'])){
                        if (!empty($_GET['t'])) {
                                ...
                                $verification = (Csrf::verifyToken('createacctoken') ? 'successful' : 'unsuccessful');
                                if($verification == 'unsuccessful'){
                                        moveto('?page=createacc');
                                }
                        }
                ...
                echo"<span style=' margin-left:5px; color:#fff !important; font-size:40px; '>Register</span>";
                    ...
                    <div class="reg-page-common">
                        ...
                        <div>
                            <form action="?page=createacc&t=submit" method="post">';
                                
                                        echo Csrf::getInputToken("createacctoken");
                                echo'
